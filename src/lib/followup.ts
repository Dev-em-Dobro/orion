import type { Lead, Outreach, Prisma } from "@prisma/client";
...
/**
 * Instante-limite da janela: uma Outreach enviada **depois** disso ainda está
 ...
 * `contatado` do tenant (com as Outreaches enviadas) e filtrava em memória, o
